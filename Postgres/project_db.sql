...
select * from project_uses_tech where tech_id =4;

select * from project_uses_tech inner join tech on id =4;

select * from project_uses_tech where project_id =4;

-- select project_id, name from tech left outer join project_uses_tech on tech.id = project_uses_tech.tech_id;
...
select distinct(tech.name) from project right outer join project_uses_tech on project_uses_tech.project_id = project.id right outer join tech on project_uses_tech.tech_id = tech.id;

select distinct(project.name) from project inner join project_uses_tech on project_uses_tech.project_id = project.id inner join tech on project_uses_tech.tech_id = tech.id;


select distinct(project.name) from project right outer join project_uses_tech on project_uses_tech.project_id = project.id right outer join tech on project_uses_tech.tech_id = tech.id where project_id is NULL;